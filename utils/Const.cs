...
namespace NickysMenu.utils
{
    class Const
    {
        ...
        public const string GUIEnableMenu = "Canvas_QuickMenu(Clone)/Container/Window/Wing_Left/Container/InnerContainer/WingMenu/ScrollRect/Viewport/VerticalLayoutGroup/Button_Emoji";
        ...
        //Names 
        public const string ModMenuButton = "Open Mod Menu";
        public const string ModTitle = "Nicky's Mod Menu";
